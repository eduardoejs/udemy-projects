...
<div class="input-field col s6">
    <select name="marca_id">
      @foreach($marcas as $key => $value)
				{{-- se existir o registro marca_id (Usuario está editando e o registro marca_id for igual ao valor_id do laço de repeticao é selected; ou se selecionou numa etapa anterior e caiu na validacao do laravel e for igual ao value_id é selected) --}}
