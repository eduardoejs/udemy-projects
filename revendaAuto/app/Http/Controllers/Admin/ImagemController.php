...
class ImagemController extends Controller
{
    ...
    public function edit($id)
    {
      ...
      return view('admin.imagem.editar', compact('registro', 'caminhos'));
    }
    ...
    public function update(Request $request, $id)
    {
      ...
      if($request->hasFile('imagem')){
        ...
        $imagemPequena = $registro->arquivos()->where('tamanho', '=', 'P')->first();
        $imagemGaleria = $registro->arquivos()->where('tamanho', '=', 'G')->first();
        $imagemSlide = $registro->arquivos()->where('tamanho', '=', 'S')->first();

        $imagemPequena->update(['url' => 'imagens/pequena-'.$imagem_nome]);
        $imagemGaleria->update(['url' => 'imagens/galeria-'.$imagem_nome]);
        $imagemSlide->update(['url' => 'imagens/slide-'.$imagem_nome]);
      }
    ...
    public function destroy($id)
    {
      ...
      //Vou atualizar o campo deletado. Nao exclui o registro de fato, pois posso querer recuperá-lo mais tarde
